...
c.$map&&(d=d.map(c.$map));void 0!==c.$take&&void 0!==c.$skip?d=d.slice(c.$skip,c.$skip+c.$take):void 0!==c.$take&&d.length>c.$take?d=d.slice(0,c.$take):c.$skip&&(d=d.slice(c.$skip,d.length));if(c.$order&&0<c.$order.length){c.$order.reverse();for(var f=0,g=c.$order.length;f<g;f++)c.$order[f].ASC?d.sort(function(a,b){var d=c.$order[f](a),e=c.$order[f](b);return d===e?0:d>e?1:-1}):d.sort(function(a,b){var d=c.$order[f](a),e=c.$order[f](b);return d===e?0:d<e?1:-1})}c.$some&&(d=[0<d.length]);c.$length&&
(d=[d.length]);a.rawDataList=d;b.success(a)},_compile:function(a){return(new $data.storageProviders.InMemory.InMemoryCompiler(this)).compile(a)},saveChanges:function(a,b){for(var c=0;c<b.length;c++){var e=b[c];switch(e.data.entityState){case $data.EntityState.Added:this.providerConfiguration.source[e.entitySet.name].push(e.data);break;case $data.EntityState.Deleted:var d=this.providerConfiguration.source[e.entitySet.name].indexOf(e.data);this.providerConfiguration.source[e.entitySet.name].splice(d,
1)}}a.success()},getTraceString:function(a){return this._compile(a)},supportedDataTypes:{value:[$data.Integer,$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.Object],writable:!1},supportedBinaryOperators:{value:{equal:{mapTo:" == ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},notEqual:{mapTo:" != ",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.OrderExpression]},equalTyped:{mapTo:" === ",
...
rightValue:") > -1",reverse:!0}}},supportedUnaryOperators:{value:{}},supportedFieldOperations:{value:{},enumerable:!0,writable:!0},supportedSetOperations:{value:{filter:{},map:{},length:{},forEach:{},toArray:{},single:{},some:{},take:{},skip:{},orderBy:{},orderByDescending:{},first:{}},enumerable:!0,writable:!0},fieldConverter:{value:{fromDb:{"$data.Integer":function(a){return a},"$data.Number":function(a){return a},"$data.Date":function(a){return a?new Date(parseInt(a.substr(6))):void 0},"$data.String":function(a){return a},
"$data.Boolean":function(a){return a},"$data.Blob":function(a){return a},"$data.Object":function(a){return void 0===a?new $data.Object:JSON.parse(a)},"$data.Array":function(a){return void 0===a?new $data.Array:JSON.parse(a)}},toDb:{"$data.Integer":function(a){return a},"$data.Number":function(a){return 0==a%1?a:a+"m"},"$data.Date":function(a){return a?"datetime'"+a.toISOString()+"'":null},"$data.String":function(a){return"'"+a.replace(/'/g,"''")+"'"},"$data.Boolean":function(a){return a?"true":"false"},
"$data.Blob":function(a){return a},"$data.Object":function(a){return JSON.stringify(a)},"$data.Array":function(a){return JSON.stringify(a)}}}}},null);$data.StorageProviderBase.registerProvider("InMemory",$data.storageProviders.InMemory.InMemoryProvider);
