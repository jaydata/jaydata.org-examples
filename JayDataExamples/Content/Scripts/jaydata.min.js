...
"function"&&b(this);return this})}function M(a,b,c,d,i){a=Da(a,b);sb(a);a.led=function(a){this.arity="infix";if(!i){I(U,n);I()}!l.bitwise&&this.bitwise&&f("unexpected_a",this);if(typeof c==="function")return c(a,this);this.first=a;this.second=r(b);return this};if(d)a.type=d;return a}function ca(a,b){a.assign&&f(b||H.conditional_assignment,a);return a}function da(a,b){switch(a.id){case "[":case "-":a.arity!=="infix"&&f(b||H.weird_condition,a);break;case "false":case "function":case "Infinity":case "NaN":case "null":case "true":case "undefined":case "void":case "(number)":case "(regexp)":case "(string)":case "{":f(b||
...
0)&&f("function_strict");Ma()}if(b){f("unreachable_a_b",g,g.value,b.value);b=null}if(c=eb()){a.push(c);if(c.disrupt){b=c;a.disrupt=true}}}return a}function ea(a){var b,c=g,d=Ea,i=F,e=na;Ea=a;F=Object.create(F);I();if(g.id==="{"){j("{");G();!a&&!Ma()&&!e&&!l.sloppy&&p["(context)"]===Y&&f("missing_use_strict");b=qa();na=e;u("}",c);m()}else if(a){f("expected_a_b",g,"{",g.value);b=[eb()];b.disrupt=b[0].disrupt}else k("expected_a_b",g,"{",g.value);p["(verb)"]=null;F=i;Ea=d;a&&b.length===0&&f("empty_block");
...
a){j();return true}return false}for(;;){if(b>=a.length)return false;f=a[b];b=b+1;if(typeof f==="boolean")break;else if(typeof f==="number"){c=f;f=a[b];b=b+1}else c=1;for(d=false;c>0;)if(kb(f)){d=true;c=c-1}else break;if(d)return true}i=b;for(c=[];;){f=false;for(b=i;b<a.length;b=b+1)if(!c[b]&&kb(Ua[a[b]])){f=d=true;c[b]=true;break}if(!f)return d}}function yb(){for(var a;;){if(g.id==="}"||g.id==="(end)"||T&&g.id===T)break;for(;g.id===";";){f("unexpected_a");W()}for(a=void 0;g.id==="*"||g.id==="#"||
...
$data.Container.registerType(["$data.Guid","Guid","guid"],$data.Guid);$data.Guid.prototype.toJSON=function(){return this.value};$data.Guid.prototype.valueOf=function(){return this.value};$data.Guid.prototype.toString=function(){return this.value};$data.parseGuid=function(a){return new $data.Guid(a)};
...
typeof b=="function"?b(a):true},minLength:function(a,b){return Object.isNullOrUndefined(a)||a.length>=b},maxLength:function(a,b){return Object.isNullOrUndefined(a)||a.length<=b},length:function(a,b){return Object.isNullOrUndefined(a)||a.length==b},regex:function(a,b){return Object.isNullOrUndefined(a)||a.match(typeof a==="string"?RegExp(b):b)}},"$data.Date":{required:function(a){return!Object.isNullOrUndefined(a)},customValidator:function(a,b){return Object.isNullOrUndefined(a)||typeof b=="function"?
b(a):true},minValue:function(a,b){return Object.isNullOrUndefined(a)||a>=b},maxValue:function(a,b){return Object.isNullOrUndefined(a)||a<=b}},"$data.Boolean":{required:function(a){return!Object.isNullOrUndefined(a)},customValidator:function(a,b){return Object.isNullOrUndefined(a)||typeof b=="function"?b(a):true}},"$data.Array":{required:function(a){return!Object.isNullOrUndefined(a)},customValidator:function(a,b){return Object.isNullOrUndefined(a)||typeof b=="function"?b(a):true},length:function(a,
b){return Object.isNullOrUndefined(a)||a.length==b}},"$data.Object":{required:function(a){return!Object.isNullOrUndefined(a)},customValidator:function(a,b){return Object.isNullOrUndefined(a)||typeof b=="function"?b(a):true}}}},fieldValidate:function(a,b,c,d,e){if(!(a.entityState==$data.EntityState.Modified&&a[b.name]==void 0)){var h=this.supportedValidations[e];h&&Object.keys(h).forEach(function(e){b[e]&&h[e]&&!h[e].call(a,c,this.getValidationValue(b,e))&&d.push(this.createValidationError(b,e,"Validation error!"))},
this)}}},null);$data.Validation.Entity=new $data.Validation.EntityValidation;$data.Class.define("$data.Notifications.ChangeDistributorBase",null,null,{distributeData:function(){Guard.raise("Pure class")}},null);
...
[];u[h].modifyAll.push(o)}break;case $data.EntityState.Deleted:c=c|$data.Access.Delete;if(i.beforeDelete){if(!u[h].deleteAll)u[h].deleteAll=[];u[h].deleteAll.push(o)}}}}var A=function(a){if(a===false){Q="async";b.length=0}b.length?G.storageProvider.saveChanges({success:function(){G._postProcessSavedItems(e,b)},error:e.error},b):Q?e.error(new Exception("Cancelled event in "+Q,"CancelEvent")):e.success(0)},Q,x=Object.getOwnPropertyNames(u),f=0,D=["beforeUpdate","beforeDelete","beforeCreate"],I={beforeCreate:"createAll",
beforeDelete:"deleteAll",beforeUpdate:"modifyAll"},C=function(a){if(a===false){Q="async";b.length=0;A(a)}else{var c=G._entitySetReferences[x[f]],d=D.pop();if(a=u[x[f]][I[d]]){for(var e=[],h=0;h<a.length;h++)e.push(a[h].data);if(!D.length){D=["beforeUpdate","beforeDelete","beforeCreate"];f++}h=c[d].call(G,e);if(typeof h==="function")h.call(G,f<x.length&&!Q?C:A,e);else if(h===false){Q=c.name+"."+d;for(c=0;c<a.length;c++){d=b.indexOf(a[c]);b.splice(d,1)}A()}else f<x.length&&!Q?C():A()}else{if(!D.length){D=
["beforeUpdate","beforeDelete","beforeCreate"];f++}f<x.length&&!Q?C():A()}}};this.user&&this.checkPermission?this.checkPermission(c,this.user,d,{success:function(){f<x.length?C():A()},error:e.error}):f<x.length?C():A();return a},prepareRequest:function(){},_postProcessSavedItems:function(a,b){this.ChangeCollector&&this.ChangeCollector instanceof $data.Notifications.ChangeCollectorBase&&this.ChangeCollector.processChangedData(b);for(var c={},d=this,e=0;e<b.length;e++){var h=b[e],f=h.data.entityState;
h.data.entityState=$data.EntityState.Unchanged;h.data.changedProperties=[];h.physicalData=void 0;var i=h.entitySet.elementType.name,k=d._entitySetReferences[i],s=void 0;switch(f){case $data.EntityState.Added:s="added";break;case $data.EntityState.Deleted:s="deleted";break;case $data.EntityState.Modified:s="updated"}s&&this.raiseEvent(s,h);if(k.afterCreate||k.afterUpdate||k.afterDelete){c[i]||(c[i]={});switch(f){case $data.EntityState.Added:if(k.afterCreate){if(!c[i].createAll)c[i].createAll=[];c[i].createAll.push(h)}break;
